 class BeatMaps{
  ...
  public ArrayList<Beat> map1(float bpm)
  {
    ...
    a.add(new Beat(.15*w, .75*h, YELLOW, .4*mspb));
    //a.add(new Beat(.5*w, .9*h, BLUE, 1.5*mspb));
    a.add(new Beat(.8*w, .2*h, GREEN, 1.4*mspb));
    //a.add(new Beat(.2*w, .9*h, RED, 2.5*mspb));
    a.add(new Beat(.05*w, .15*h, YELLOW, 2.6*mspb));
    ...
    a.add(new Beat(.8*w, .7*h, GREEN, 25.25*mspb));
    a.add(new Beat(.5*w, .5*h, RED, 25.5*mspb));
    a.add(new Beat(.15*w, .75*h, YELLOW, 25.75*mspb));
    a.add(new Beat(.5*w, .9*h, BLUE, 26*mspb));
    a.add(new Beat(.8*w, .7*h, GREEN, 26.25*mspb));
    a.add(new Beat(.5*w, .5*h, RED, 26.5*mspb));
